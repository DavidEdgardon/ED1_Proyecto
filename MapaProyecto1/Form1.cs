...
namespace MapaProyecto1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            dt2.Columns.Add(new DataColumn("Desde", typeof(string)));
            dt2.Columns.Add(new DataColumn("Hasta", typeof(string)));
            dt2.Columns.Add(new DataColumn("Distancia", typeof(double)));
   ...
   */
           ...
           BackEnd.GuardarRutas(1, lng, lat, desc);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            codigo = Microsoft.VisualBasic.Interaction.InputBox("Ingrese el codigo del marcador a modificar", "Registro de Datos", "", 300, 300);

            nuevo = Microsoft.VisualBasic.Interaction.InputBox("Ingrese el nuevo nombre del marcador", "Registro de Datos", "", 300, 300);



            MessageBox.Show("Se ha guardado : " + codigo, "Sistema de Mapa", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private void btnEditarRuta_Click(object sender, EventArgs e)
        {
            ...
            codigo = Microsoft.VisualBasic.Interaction.InputBox("Ingrese el codigo de la Ruta a modificar", "Registro de Datos", "", 300, 300);

            nuevo = Microsoft.VisualBasic.Interaction.InputBox("Ingrese el nuevo codigo de Ruta", "Registro de Datos", "", 300, 300);



            MessageBox.Show("Se ha modificado la Ruta : " + codigo, "Sistema de Mapa", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            ...
            for (int i = 0; i < dataGridView2.Rows.Count; i++)
            {
                ...
                if (dataGridView2.Rows[i].Cells[0].Value.ToString() == codigo)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            codigo = Microsoft.VisualBasic.Interaction.InputBox("Ingrese el Codigo de Ruta a borrar", "Registro de Datos", "", 300, 300);



            MessageBox.Show("Se ha agrado Borrardo la ruta", "Sistema de Mapa", MessageBoxButtons.OK, MessageBoxIcon.Information);
